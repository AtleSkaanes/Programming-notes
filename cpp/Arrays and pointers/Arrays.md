...
Meaning you start at the memory address of the first element. Then move the index times the size of the type forward in bytes to find the element at the index.
...
Go to the [[Pointers & References]] file for more info on pointers.
